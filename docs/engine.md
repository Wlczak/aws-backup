...
- The full-download job tracks the missing-set object count plus a pessimistic GET/egress/total cost estimate in the live job summary so the dashboard can surface the maximum likely price alongside scan and progress state.
